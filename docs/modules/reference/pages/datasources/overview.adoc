...
This stream of information represents your monitored network, its provisioned inventory, and the relationships between the inventory items.
...
Its default implementation can be found in `inventory.groovy` in each datasource bundle:

...
const HL = /* @__PURE__ */ re(YL, [["__scopeId", "data-v-524b0835"]]), GL = window.Vue.defineComponent, Ht = window.Vue.createVNode, Vt = window.Vue.unref, gc = window.Vue.normalizeClass, pa = window.Vue.toDisplayString, co = window.Vue.openBlock, fo = window.Vue.createElementBlock, _c = window.Vue.createCommentVNode, jL = window.Vue.withCtx, Qt = window.Vue.createElementVNode, KL = window.Vue.Fragment, QL = window.Vue.pushScopeId, JL = window.Vue.popScopeId, e6 = (e) => (QL("data-v-8ed6502c"), e = e(), JL(), e), t6 = { class: "section" }, n6 = { class: "action-section" }, r6 = {
  key: 0,
  class: "btn-row"
}, o6 = { key: 0 }, s6 = { key: 1 }, i6 = {
  key: 0,
  class: "situation-detail"
}, a6 = { class: "situation-info" }, l6 = { class: "id" }, u6 = ["innerHTML"], c6 = /* @__PURE__ */ e6(() => /* @__PURE__ */ Qt("p", null, null, -1)), d6 = { class: "boxes" }, f6 = { class: "parameters" }, A6 = { class: "section memo-boxes" }, h6 = { key: 0 }, kw = window.Vue.ref, p6 = window.Vue.watch, w6 = /* @__PURE__ */ GL({
  ...
  setup(e) {
    ...
    return (v, m) => {
      ...
      return co(), fo(KL, null, [
            ...
            Vt(u).allowSave ? (co(), fo("div", r6, [
              Ht(Vt(le), {
                ...
                default: jL(() => [
                  ...
                  c.value == Vt(a) ? (co(), fo("span", o6, pa(Vt(a)), 1)) : (co(), fo("span", s6, " REJECT"))
                ]),
                _: 1
              }, 8, ["class"])
            ])) : _c("", !0)
          ]),
          f.value ? (co(), fo("div", i6, [
            Qt("div", {
        ...
        f.value.alarms && f.value.alarms.length ? (co(), fo("div", h6, [
          Ht(HL, {
...
const v6 = /* @__PURE__ */ re(w6, [["__scopeId", "data-v-8ed6502c"]]);
var m6 = Object.defineProperty, g6 = Object.defineProperties, _6 = Object.getOwnPropertyDescriptors, Nw = Object.getOwnPropertySymbols, V6 = Object.prototype.hasOwnProperty, y6 = Object.prototype.propertyIsEnumerable, Dw = (e, o, r) => o in e ? m6(e, o, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[o] = r, Zc = (e, o) => {
  for (var r in o || (o = {}))
    V6.call(o, r) && Dw(e, r, o[r]);
  if (Nw)
    for (var r of Nw(o))
      y6.call(o, r) && Dw(e, r, o[r]);
  return e;
}, b6 = (e, o) => g6(e, _6(o));
const t1 = window.Vue.defineComponent, $r = window.Vue.resolveComponent, Ca = window.Vue.openBlock, Ow = window.Vue.createBlock, Ea = window.Vue.mergeProps, Ir = window.Vue.withCtx, n1 = window.Vue.createElementBlock, C6 = window.Vue.Fragment, E6 = window.Vue.renderList, M6 = window.Vue.createTextVNode, B6 = window.Vue.toDisplayString, $6 = window.Vue.computed, Lw = window.Vue.toRef, Es = window.Vue.createVNode, zw = window.Vue.toHandlers, I6 = window.Vue.renderSlot, x6 = window.Vue.normalizeClass, S6 = window.Vue.createElementVNode;
var r1 = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
function P6(e, o, r, i, a, u) {
  ...
  return Ca(), Ow(f, Ea(e.listAttrs, {
    ...
    default: Ir(() => [
      (Ca(!0), n1(C6, null, E6(e.options, (p, v) => (Ca(), Ow(c, {
        key: p[e.textProp],
        "as-li": "",
        id: e.getId(v),
        role: "option",
...
var k6 = /* @__PURE__ */ r1(T6, [["render", P6], ["__scopeId", "data-v-eae820da"]]);
const N6 = b6(Zc(Zc({}, id), Ks), {
  modelValue: {
    type: Object,
    required: !1
  },
  ...
  setup(e, o) {
    Qs(e), ad(e);
    const r = $6(() => ie("feather-select-input")), { validate: i } = Gs(r, Lw(e, "modelValue"), e.label, e.schema, Lw(e, "error"));
    return Zc({
      inputId: r,
      validate: i
    }, js(o.attrs));
...
var z6 = /* @__PURE__ */ r1(O6, [["render", L6], ["__scopeId", "data-v-ecb32d90"]]);
const q6 = window.Vue.openBlock, R6 = window.Vue.createElementBlock, o1 = window.Vue.createElementVNode;
var W6 = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
const F6 = {}, X6 = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Z6 = /* @__PURE__ */ o1("path", { d: "M16,11H13V8a1,1,0,0,0-2,0v3H8a1,1,0,0,0,0,2h3v3a1,1,0,0,0,2,0V13h3a1,1,0,0,0,0-2Z" }, null, -1), U6 = /* @__PURE__ */ o1("path", { d: "M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" }, null, -1), Y6 = [
  Z6,
  U6
];
function H6(e, o) {
  return q6(), R6("svg", X6, Y6);
}
var G6 = /* @__PURE__ */ W6(F6, [["render", H6]]);
const Ma = window.Vue.openBlock, Uc = window.Vue.createElementBlock, s1 = window.Vue.createElementVNode, j6 = window.Vue.defineComponent, br = window.Vue.ref, K6 = window.Vue.provide, qw = window.Vue.computed, Q6 = window.Vue.onUnmounted, Rw = window.Vue.toRef, J6 = window.Vue.resolveComponent, e8 = window.Vue.Fragment, t8 = window.Vue.createBlock, n8 = window.Vue.Teleport, Ww = window.Vue.createVNode, r8 = window.Vue.Transition, o8 = window.Vue.withCtx, s8 = window.Vue.normalizeClass, i8 = window.Vue.normalizeStyle, a8 = window.Vue.toDisplayString, l8 = window.Vue.createCommentVNode, u8 = window.Vue.renderSlot, Vc = window.Vue.nextTick;
var i1 = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
function h8(e, o) {
  return Ma(), Uc("svg", d8, A8);
}
var p8 = /* @__PURE__ */ i1(c8, [["render", h8]]), Fe = /* @__PURE__ */ ((e) => (e.top = "top", e.bottom = "bottom", e.left = "left", e.right = "right", e))(Fe || {}), Pn = /* @__PURE__ */ ((e) => (e.center = "center", e.left = "left", e.right = "right", e))(Pn || {});
const w8 = (e, o, r, i = 9) => {
  ...
  setup(e) {
    ...
    const M = () => document.getElementById(a), P = () => {
      ...
      Vc(() => {
        const Ee = ye.getBoundingClientRect(), Ie = ve.getBoundingClientRect(), Ae = w8(Ee, Ie, T.value, S), Le = v8(Ae, Ee, Ie, N.value, q);
...
function V8(e, o, r, i, a, u) {
  const c = J6("Pointer");
  return Ma(), Uc(e8, null, [
    (Ma(), t8(n8, { to: "body" }, [
      Ww(r8, { css: e.animate }, {
        default: o8(() => [
          e.show ? (Ma(), Uc("div", {
            key: 0,
            class: s8(["feather-tooltip-container", [e.alignmentClass, e.placementClass]]),
            ref: "tooltip",
            style: i8({ left: e.left, top: e.top })
          }, [
            s1("div", {
              class: "tooltip",
              role: "tooltip",
...
var Fw = /* @__PURE__ */ i1(g8, [["render", V8], ["__scopeId", "data-v-3da6b22e"]]);
const y8 = window.Vue.defineComponent, yc = window.Vue.normalizeStyle, bc = window.Vue.createElementVNode, Ms = window.Vue.unref, Xw = window.Vue.toHandlers, Zw = window.Vue.mergeProps, Uw = window.Vue.withCtx, Yw = window.Vue.createVNode, b8 = window.Vue.renderList, C8 = window.Vue.Fragment, Bs = window.Vue.openBlock, $s = window.Vue.createElementBlock, Hw = window.Vue.normalizeClass, Gw = window.Vue.createCommentVNode;
window.Vue.pushScopeId;
window.Vue.popScopeId;
const E8 = { class: "row" }, M8 = /* @__PURE__ */ y8({
  __name: "Timeline",
  props: {
    alarm: null,
    proportion: null,
  ...
  setup(e) {
    ...
    return (u, c) => (Bs(), $s("div", E8, [
      ...
      (Bs(!0), $s(C8, null, b8(o.events, (f, p) => (Bs(), $s("div", {
        class: "event-trim",
        key: f.id
      }, [
...
const B8 = /* @__PURE__ */ re(M8, [["__scopeId", "data-v-3341d12d"]]), $8 = window.Vue.openBlock, I8 = window.Vue.createElementBlock, a1 = window.Vue.createElementVNode;
var x8 = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
const S8 = {}, T8 = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, P8 = /* @__PURE__ */ a1("path", { d: "M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" }, null, -1), k8 = /* @__PURE__ */ a1("path", { d: "M16,11H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z" }, null, -1), N8 = [
  P8,
  k8
];
function D8(e, o) {
  return $8(), I8("svg", T8, N8);
}
var O8 = /* @__PURE__ */ x8(S8, [["render", D8]]);
const L8 = window.Vue.defineComponent, Yc = window.Vue.createElementVNode, z8 = window.Vue.renderList, jw = window.Vue.Fragment, Cc = window.Vue.openBlock, Ec = window.Vue.createElementBlock, q8 = window.Vue.normalizeClass, R8 = window.Vue.unref, Kw = window.Vue.toDisplayString, W8 = window.Vue.pushScopeId, F8 = window.Vue.popScopeId, X8 = (e) => (W8("data-v-2e087f7b"), e = e(), F8(), e), Z8 = /* @__PURE__ */ X8(() => /* @__PURE__ */ Yc("strong", null, "Events:", -1)), U8 = /* @__PURE__ */ L8({
  __name: "EventsList",
  props: {
    events: null
  },
  setup(e) {
    ...
    return (r, i) => (Cc(), Ec(jw, null, [
      Z8,
      (Cc(!0), Ec(jw, null, z8(o.events, (a) => (Cc(), Ec("div", {
        class: "event-description",
        key: a.id
      }, [
        Yc("div", {
          class: q8(["mark", [`${a.severity.toLowerCase()}-bg dark`]])
        }, null, 2),
        Yc("div", null, Kw(R8(pn)(a.createTime)) + " - " + Kw(a.source), 1)
      ]))), 128))
    ], 64));
  }
});
const Y8 = /* @__PURE__ */ re(U8, [["__scopeId", "data-v-2e087f7b"]]), H8 = window.Vue.defineComponent, G8 = window.Vue.normalizeClass, yt = window.Vue.createElementVNode, Ao = window.Vue.toDisplayString, lt = window.Vue.unref, ho = window.Vue.createVNode, l1 = window.Vue.createTextVNode, j8 = window.Vue.renderList, Qw = window.Vue.Fragment, In = window.Vue.openBlock, Cr = window.Vue.createElementBlock, Jw = window.Vue.createBlock, wa = window.Vue.createCommentVNode, K8 = window.Vue.normalizeStyle, Q8 = window.Vue.pushScopeId, J8 = window.Vue.popScopeId, ez = (e) => (Q8("data-v-01717d0d"), e = e(), J8(), e), tz = { class: "section detail" }, nz = { class: "id" }, rz = {
  key: 0,
  class: "section"
}, oz = /* @__PURE__ */ ez(() => /* @__PURE__ */ yt("div", { class: "id" }, "Alarms", -1)), sz = { class: "action-btns" }, iz = { class: "zoom" }, az = /* @__PURE__ */ l1(" Zoom "), lz = { class: "times" }, uz = {
  key: 0,
  class: "timeline-container"
}, cz = { class: "alarm-id" }, dz = {
  key: 0,
  class: "panel"
}, Gn = window.Vue.ref, fz = window.Vue.watch, Az = /* @__PURE__ */ H8({
  ...
  setup(e) {
    ...
    return (z, O) => {
      ...
      return In(), Cr(Qw, null, [
        yt("div", tz, [
          yt("div", {
            class: G8(["severity-line", [`${(ge = (F = o.situation) == null ? void 0 : F.severity) == null ? void 0 : ge.toLowerCase()}-bg dark`]])
          }, null, 2),
          yt("div", null, [
            yt("div", nz, "Situation " + Ao(o.situation.id), 1),
            yt("div", null, " Duration: " + Ao(lt(Xa)(p.value, new Date(V.value))), 1)
          ])
        ]),
        _.value && _.value.length > 0 ? (In(), Cr("div", rz, [
          oz,
          yt("div", sz, [
            ho(lt(z6), {
              class: "select",
          ...
          f.value ? (In(), Cr("div", {
            ...
            e.situation.events ? (In(), Cr("div", uz, [
              (In(!0), Cr(Qw, null, j8(_.value, (fe) => (In(), Cr("div", {
                class: "timeline",
                key: fe.id
              }, [
                yt("div", cz, [
...
const hz = /* @__PURE__ */ re(Az, [["__scopeId", "data-v-01717d0d"]]), pz = window.Vue.openBlock, wz = window.Vue.createElementBlock, vz = window.Vue.createElementVNode;
var mz = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
const gz = {}, _z = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Vz = /* @__PURE__ */ vz("path", { d: "M18,11H8.83l3.29-3.29a1,1,0,0,0,0-1.42,1,1,0,0,0-1.41,0L5,12l5.71,5.71a1,1,0,1,0,1.41-1.41L8.83,13H18a1,1,0,0,0,0-2Z" }, null, -1), yz = [
  Vz
];
function bz(e, o) {
  return pz(), wz("svg", _z, yz);
}
var Mo = /* @__PURE__ */ mz(gz, [["render", bz]]);
const u1 = window.Vue.defineComponent, Mc = window.Vue.ref, Cz = window.Vue.toRef, Bc = window.Vue.inject, ev = window.Vue.watch, Ez = window.Vue.nextTick, tv = window.Vue.openBlock, nv = window.Vue.createElementBlock, $c = window.Vue.createElementVNode, Mz = window.Vue.normalizeClass, rv = window.Vue.renderSlot, ov = window.Vue.createCommentVNode, Ic = window.Vue.provide;
window.Vue.createBlock;
window.Vue.Teleport;
var Bz = (e, o) => {
  const r = e.__vccOpts || e;
...
const $z = {
  ...
  props: $z,
  setup(e, o) {
    const r = Mc(), i = Mc(!1), a = Mc(!1), u = Date.now() + Math.floor(Math.random() * 1e3), c = Cz(e, "modelValue"), f = Bc("queueSnackbar", !1), p = Bc("unqueueSnackbar", !1), v = Bc("nextSnackbar", () => {
    }), m = (P, D) => {
      let T, N, S = D;
      const q = () => {
...
function Nz(e, o, r, i, a, u) {
  return e.modelValue || e.contentShow ? (tv(), nv("div", Sz, [
    $c("div", {
      class: Mz(["feather-snackbar", {
...
var rl = /* @__PURE__ */ Bz(xz, [["render", Nz], ["__scopeId", "data-v-5cf64a62"]]);
const Dz = {
  target: {
    type: String,
    default: "body"
...
const Oz = window.Vue.defineComponent, $e = window.Vue.unref, ut = window.Vue.createVNode, Us = window.Vue.createElementVNode, kt = window.Vue.withCtx, po = window.Vue.openBlock, sv = window.Vue.createBlock, Lz = window.Vue.createCommentVNode, ol = window.Vue.createTextVNode, va = window.Vue.createElementBlock, iv = window.Vue.toDisplayString, zz = window.Vue.pushScopeId, qz = window.Vue.popScopeId, Ed = (e) => (zz("data-v-e88438ff"), e = e(), qz(), e), Rz = { id: "cont" }, Wz = { class: "btns-navigation" }, Fz = /* @__PURE__ */ Ed(() => /* @__PURE__ */ Us("span", null, "Situation List", -1)), Xz = /* @__PURE__ */ Ed(() => /* @__PURE__ */ Us("span", null, "Show Previous Situation ", -1)), Zz = /* @__PURE__ */ Ed(() => /* @__PURE__ */ Us("span", null, "Show Next Situation", -1)), Uz = { key: 1 }, Yz = {
  key: 0,
  class: "detail"
}, Hz = /* @__PURE__ */ ol("Details"), Gz = /* @__PURE__ */ ol("Metrics"), jz = {
  key: 1,
  class: "noSituation"
}, Kz = /* @__PURE__ */ ol("dismiss"), wo = window.Vue.ref, av = window.Vue.watch, Qz = window.Vue.onMounted, Jz = window.VueRouter.useRoute, e4 = /* @__PURE__ */ Oz({
  __name: "SituationDetail",
  setup(e) {
    const o = vn(), r = Jz(), i = parseInt(r.params.id), a = wo(i), u = rn(), c = el();
    ...
    return av(r, () => {
      ...
      v.value ? (po(), sv($e(Ad), {
        ...
        f.value ? (po(), va("div", Yz, [
          ut($e(rD), null, {
            ...
            default: kt(() => [
              ut($e(qp), { class: "panel" }, {
                default: kt(() => [
                  ut(v6, { "situation-info": f.value }, null, 8, ["situation-info"])
                ]),
                _: 1
              }),
              ut($e(qp), { class: "panel" }, {
        ...
        ])) : (po(), va("div", jz, " Error. The situation " + iv($e(i)) + " does not exist. ", 1))
      ])),
      ut($e(rl), {
        modelValue: _.value,
...
const t4 = /* @__PURE__ */ re(e4, [["__scopeId", "data-v-e88438ff"]]), n4 = window.Vue.defineComponent, We = window.Vue.unref, Nt = window.Vue.createVNode, rt = window.Vue.createElementVNode, vo = window.Vue.withCtx, mo = window.Vue.openBlock, Is = window.Vue.createElementBlock, r4 = window.Vue.createCommentVNode, o4 = window.Vue.toDisplayString, Md = window.Vue.createTextVNode, s4 = window.Vue.normalizeClass, i4 = window.Vue.renderList, a4 = window.Vue.Fragment, l4 = window.Vue.createBlock, u4 = window.Vue.pushScopeId, c4 = window.Vue.popScopeId, ti = (e) => (u4("data-v-1a57a9f3"), e = e(), c4(), e), d4 = { class: "container" }, f4 = /* @__PURE__ */ ti(() => /* @__PURE__ */ rt("span", null, "Situation List", -1)), A4 = /* @__PURE__ */ ti(() => /* @__PURE__ */ rt("h2", null, "New Situation", -1)), h4 = { class: "form" }, p4 = { class: "fields" }, w4 = {
  key: 0,
  class: "errorList"
...
const T4 = /* @__PURE__ */ re(S4, [["__scopeId", "data-v-1a57a9f3"]]), P4 = window.Vue.openBlock, k4 = window.Vue.createElementBlock, N4 = window.Vue.createElementVNode;
var D4 = (e, o) => {
  const r = e.__vccOpts || e;
  for (const [i, a] of o)
    r[i] = a;
...
const eR = /* @__PURE__ */ re(Jq, [["__scopeId", "data-v-bcb7dcc6"]]), tR = window.Vue.defineComponent, nt = window.Vue.unref, jt = window.Vue.createVNode, Jn = window.Vue.createElementVNode, xs = window.Vue.withCtx, Mr = window.Vue.openBlock, cv = window.Vue.createBlock, nR = window.Vue.renderList, rR = window.Vue.Fragment, Ss = window.Vue.createElementBlock, oR = window.Vue.toDisplayString, c1 = window.Vue.createTextVNode, sR = window.Vue.pushScopeId, iR = window.Vue.popScopeId, $d = (e) => (sR("data-v-6078e4ad"), e = e(), iR(), e), aR = { class: "container" }, lR = { class: "nav-btns" }, uR = /* @__PURE__ */ $d(() => /* @__PURE__ */ Jn("span", null, "Situation List", -1)), cR = /* @__PURE__ */ $d(() => /* @__PURE__ */ Jn("h2", null, "List Unassociated Alarms", -1)), dR = { class: "content" }, fR = { class: "filters" }, AR = { class: "list" }, hR = { class: "action-btns" }, pR = /* @__PURE__ */ $d(() => /* @__PURE__ */ Jn("span", null, "Move", -1)), wR = { key: 1 }, vR = {
  key: 0,
  class: "alarms"
...
const nW = /* @__PURE__ */ re(tW, [["__scopeId", "data-v-17251e76"]]), rW = window.Vue.defineComponent, Dt = window.Vue.createVNode, fn = window.Vue.createElementVNode, sr = window.Vue.createTextVNode, Ge = window.Vue.unref, Kt = window.Vue.withCtx, oW = window.Vue.toDisplayString, sW = window.Vue.Fragment, iW = window.Vue.openBlock, aW = window.Vue.createElementBlock, lW = window.Vue.pushScopeId, uW = window.Vue.popScopeId, il = (e) => (lW("data-v-f91e9577"), e = e(), uW(), e), cW = { class: "container" }, dW = /* @__PURE__ */ il(() => /* @__PURE__ */ fn("h3", null, "Configuration Page", -1)), fW = { class: "section" }, AW = /* @__PURE__ */ il(() => /* @__PURE__ */ fn("div", { class: "title" }, " Allow ALEC to send anonymous usage data to The OpenNMS Group? ", -1)), hW = /* @__PURE__ */ sr("Yes"), pW = /* @__PURE__ */ sr("No"), wW = { class: "section" }, vW = { class: "title" }, mW = /* @__PURE__ */ sr(" Choose the correlation engine that ALEC will use (see "), gW = ["href"], _W = /* @__PURE__ */ sr(" for more information): "), VW = /* @__PURE__ */ sr("Clustering"), yW = /* @__PURE__ */ il(() => /* @__PURE__ */ fn("div", { class: "hellinger" }, [
...
const $W = /* @__PURE__ */ re(BW, [["__scopeId", "data-v-f91e9577"]]), IW = window.VueRouter.createRouter, xW = window.VueRouter.createWebHistory, Sc = async () => {
  const e = Nn();

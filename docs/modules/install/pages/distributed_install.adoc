...
In addition to an existing instance of OpenNMS Horizon 24.0.0 or greater, this guide assume you have:
...
When installing the package repository, ensure that this is done on all of the system that are running _Sentinel_ and/or _OpenNMS_.

...
const dd = (n) => {
  ...
  setup(n) {
    const i = n, a = wl(), l = ref(a.alarms[i.id]);
    return watch(i, () => {
...
const QJ = /* @__PURE__ */ Pe(xJ, [["__scopeId", "data-v-e08880d6"]]), BJ = window.Vue.defineComponent, za = window.Vue.createElementVNode, kf = window.Vue.createTextVNode, Aa = window.Vue.unref, pd = window.Vue.normalizeClass, Lo = window.Vue.withCtx, _o = window.Vue.createVNode, md = window.Vue.renderList, qo = window.Vue.Fragment, Dn = window.Vue.openBlock, xa = window.Vue.createElementBlock, DJ = window.Vue.toDisplayString, Vd = window.Vue.createBlock, OJ = window.Vue.pushScopeId, CJ = window.Vue.popScopeId, GJ = (n) => (OJ("data-v-4d8a6eca"), n = n(), CJ(), n), zJ = /* @__PURE__ */ GJ(() => /* @__PURE__ */ za("div", { class: "title" }, "Alarms", -1)), YJ = { class: "alarm-filters-container" }, IJ = /* @__PURE__ */ kf(" ALL "), HJ = { class: "section" }, PJ = { class: "alarm-list" }, Td = window.Vue.ref, jJ = window.Vue.watch, XJ = window.Vue.computed, LJ = /* @__PURE__ */ BJ({
  __name: "AlarmFilters",
  props: {
    relatedAlarms: null
  },
...
var qJ = Object.defineProperty, KJ = Object.defineProperties, $J = Object.getOwnPropertyDescriptors, Ud = Object.getOwnPropertySymbols, eg = Object.prototype.hasOwnProperty, tg = Object.prototype.propertyIsEnumerable, Rd = (n, i, a) => i in n ? qJ(n, i, { enumerable: !0, configurable: !0, writable: !0, value: a }) : n[i] = a, wr = (n, i) => {
  for (var a in i || (i = {}))
    eg.call(i, a) && Rd(n, a, i[a]);
  if (Ud)
    for (var a of Ud(i))
      tg.call(i, a) && Rd(n, a, i[a]);
  return n;
}, vd = (n, i) => KJ(n, $J(i));
...
}), ug = window.Vue.defineComponent, fn = window.Vue.unref, Zr = window.Vue.normalizeClass, St = window.Vue.createVNode, On = window.Vue.openBlock, Cn = window.Vue.createElementBlock, dg = window.Vue.createCommentVNode, Nd = window.Vue.withCtx, rt = window.Vue.createElementVNode, wd = window.Vue.toDisplayString, fg = window.Vue.createTextVNode, hg = window.Vue.Fragment, pg = window.Vue.pushScopeId, mg = window.Vue.popScopeId, Vg = (n) => (pg("data-v-f63db227"), n = n(), mg(), n), Tg = { class: "section" }, Ug = {
  key: 0,
  class: "btn-row"
        ...
        rt("div", Tg, [
          fn(l).allowSave ? (On(), Cn("div", Ug, [
            St(fn(_a), {
              ...
              default: Nd(() => [
                ...
                c.value == "ACCEPTED" ? (On(), Cn("span", Rg, " ACCEPTED")) : (On(), Cn("span", vg, " ACCEPT"))
              ]),
              _: 1
            }, 8, ["class"]),
            St(fn(_a), {
              ...
              default: Nd(() => [
                ...
                c.value == "REJECTED" ? (On(), Cn("span", Ng, " REJECTED")) : (On(), Cn("span", wg, " REJECT"))
              ]),
              _: 1
            }, 8, ["class"])
          ])) : dg("", !0),
          rt("div", Mg, [
            ...
            rt("div", Zg, [
              ...
              rt("p", null, [
                kg,
                fg(" " + wd(i.alarmInfo.reductionKey), 1)
              ]),
              rt("div", yg, [
                St(Ku, {
                  label: "First Event",
...
const Ag = /* @__PURE__ */ Pe(Sg, [["__scopeId", "data-v-f63db227"]]), xg = window.Vue.defineComponent, Qg = window.Vue.createTextVNode, Ko = window.Vue.unref, Qa = window.Vue.withCtx, Ba = window.Vue.createVNode, Bg = window.Vue.openBlock, Dg = window.Vue.createElementBlock, Og = window.Vue.createCommentVNode;
window.Vue.pushScopeId;
window.Vue.popScopeId;
const Cg = {
  key: 0,
...
const Yg = /* @__PURE__ */ Pe(zg, [["__scopeId", "data-v-85513d07"]]), Ig = window.Vue.defineComponent, ul = window.Vue.createElementVNode, Md = window.Vue.unref, Hg = window.Vue.renderList, Pg = window.Vue.Fragment, $o = window.Vue.openBlock, el = window.Vue.createElementBlock, Zd = window.Vue.createVNode, jg = window.Vue.pushScopeId, Xg = window.Vue.popScopeId, Lg = (n) => (jg("data-v-0e46f90e"), n = n(), Xg(), n), _g = { class: "list-main" }, qg = /* @__PURE__ */ Lg(() => /* @__PURE__ */ ul("h2", null, "Situation List", -1)), Kg = { class: "container" }, $g = { class: "situation-list" }, ek = window.Vue.reactive, tk = /* @__PURE__ */ Ig({
  ...
  setup(n) {
    ...
    return i.$subscribe((c, f) => {
      ...
      ul("div", Kg, [
        ul("div", $g, [
          ($o(!0), el(Pg, null, Hg(Md(i).situations, (p) => ($o(), el("div", {
            key: p.id
          }, [
            Zd(Dv, {
              "alarm-info": p,
...
const nk = /* @__PURE__ */ Pe(tk, [["__scopeId", "data-v-0e46f90e"]]);
var rk = Object.defineProperty, ak = Object.defineProperties, ik = Object.getOwnPropertyDescriptors, Jd = Object.getOwnPropertySymbols, ok = Object.prototype.hasOwnProperty, lk = Object.prototype.propertyIsEnumerable, gd = (n, i, a) => i in n ? rk(n, i, { enumerable: !0, configurable: !0, writable: !0, value: a }) : n[i] = a, Ya = (n, i) => {
  for (var a in i || (i = {}))
    ok.call(i, a) && gd(n, a, i[a]);
  if (Jd)
    for (var a of Jd(i))
      lk.call(i, a) && gd(n, a, i[a]);
  return n;
}, yf = (n, i) => ak(n, ik(i));
const bf = window.Vue.defineComponent, sk = window.Vue.ref, Wr = window.Vue.computed, ck = window.Vue.reactive, kd = window.Vue.watch, tl = window.Vue.inject, Ef = window.Vue.resolveComponent, dl = window.Vue.openBlock, Wf = window.Vue.createElementBlock, Kt = window.Vue.createElementVNode, uk = window.Vue.createBlock, dk = window.Vue.createCommentVNode, Ff = window.Vue.renderSlot, fk = window.Vue.pushScopeId, hk = window.Vue.popScopeId, nl = window.Vue.toRef, yd = window.Vue.mergeProps, pk = window.Vue.toDisplayString, mk = window.Vue.createVNode;
var Sf = (n, i) => {
  const a = n.__vccOpts || n;
  for (const [l, c] of i)
    a[l] = c;
...
const xf = () => window.VRouter || Fl, ky = window.Vue.defineComponent, de = window.Vue.createElementVNode, Ar = window.Vue.createTextVNode, be = window.Vue.unref, At = window.Vue.createVNode, Da = window.Vue.withCtx, bd = window.Vue.openBlock, Ed = window.Vue.createElementBlock, yy = window.Vue.createCommentVNode, by = window.Vue.pushScopeId, Ey = window.Vue.popScopeId, ht = (n) => (by("data-v-0fd6b0cd"), n = n(), Ey(), n), Wy = { class: "container" }, Fy = /* @__PURE__ */ ht(() => /* @__PURE__ */ de("div", { class: "title" }, "ALEC", -1)), Sy = /* @__PURE__ */ ht(() => /* @__PURE__ */ de("div", { class: "description" }, [
...
var e2 = Object.defineProperty, t2 = Object.defineProperties, n2 = Object.getOwnPropertyDescriptors, Wd = Object.getOwnPropertySymbols, r2 = Object.prototype.hasOwnProperty, a2 = Object.prototype.propertyIsEnumerable, Fd = (n, i, a) => i in n ? e2(n, i, { enumerable: !0, configurable: !0, writable: !0, value: a }) : n[i] = a, fl = (n, i) => {
  for (var a in i || (i = {}))
    r2.call(i, a) && Fd(n, a, i[a]);
  if (Wd)
    for (var a of Wd(i))
      a2.call(i, a) && Fd(n, a, i[a]);
  return n;
}, Qf = (n, i) => t2(n, n2(i));
const Bf = window.Vue.defineComponent, i2 = window.Vue.inject, o2 = window.Vue.resolveComponent, rl = window.Vue.openBlock, Sd = window.Vue.createElementBlock, zn = window.Vue.createElementVNode, l2 = window.Vue.createBlock, Ad = window.Vue.createCommentVNode, s2 = window.Vue.renderSlot, c2 = window.Vue.pushScopeId, u2 = window.Vue.popScopeId, al = window.Vue.toRef, Oa = window.Vue.computed, d2 = window.Vue.ref;
...
], -1)), O2 = /* @__PURE__ */ hl(" Continue "), xd = window.Vue.ref, C2 = /* @__PURE__ */ J2({

 ...
 */
public class DeepLearningRemoteEngine extends AbstractClusterEngine {
    private final DeepLearningEngineConf conf;
    private final TFModel tfModel;
    private TFClusterer tfClusterer;

    public DeepLearningRemoteEngine(MetricRegistry metrics, DeepLearningEngineConf conf, String token, String uri) {
        this(metrics, new TFModel(token, uri), conf);
    }

    private DeepLearningRemoteEngine(MetricRegistry metrics, TFModel tfModel, DeepLearningEngineConf conf) {
        super(metrics);

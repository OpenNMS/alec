...
package org.opennms.alec.features.graph.shell;
...
import org.opennms.alec.features.graph.graphml.InvalidGraphException;
import org.osgi.framework.BundleContext;

@Command(scope = "opennms-alec", name = "export-graph", description = "Export an engine's graph to GraphML\n" +
        "Use opennms-alec:list-graphs to enumerate the available providers.")
@Service

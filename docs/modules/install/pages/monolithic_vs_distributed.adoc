...
If you are looking for something easy to setup to perform an evalualation or test with your existing environment, consider the xref:monolithic_install.adoc[monolithic deployment].

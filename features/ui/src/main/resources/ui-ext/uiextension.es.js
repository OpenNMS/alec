...
var MainContainer_vue_vue_type_style_index_0_scoped_true_lang = "";
...
function _sfc_render$f(_ctx, _cache) {
  ...
  return _openBlock$b(), _createElementBlock$a("div", _hoisted_1$n, [
    _createVNode$7(_component_router_view)
  ]);
}
var MainContainer = /* @__PURE__ */ _export_sfc$j(_sfc_main$t, [["render", _sfc_render$f], ["__scopeId", "data-v-94da7af6"]]);
...
const _sfc_main$s = /* @__PURE__ */ _defineComponent$a({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return _openBlock$a(), _createBlock$1(MainContainer);
    };
  }
});
...
const rest = axios.create({
  baseURL: ("/opennms/rest" == null ? void 0 : "/opennms/rest".toString()) || "/opennms/rest",
  withCredentials: true
});
...
const defineStore$1 = window["Pinia"].defineStore;
const useSituationsStore = defineStore$1("situationsStore", {
  state: () => ({
    situations: [],
    alarms: {}
  }),
  actions: {
    async getSituations() {
      ...
      if (result) {
        this.alarms = lodash.exports.mapKeys(result.alarm, (value) => {
          return value.id;
        });
...
const _sfc_main$r = /* @__PURE__ */ _defineComponent$9({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return (props2 == null ? void 0 : props2.severity) ? (_openBlock$9(), _createElementBlock$9("span", {
        key: 0,
        class: _normalizeClass$4(["severity-status", [`${props2.severity.toLowerCase()}-color`]])
      }, _toDisplayString$6(props2.severity), 3)) : _createCommentVNode$3("", true);
    };
  }
});
var SeverityStatus = /* @__PURE__ */ _export_sfc$j(_sfc_main$r, [["__scopeId", "data-v-5c297c57"]]);
...
const _sfc_main$q = /* @__PURE__ */ _defineComponent$8({
  ...
  setup(__props) {
    const props2 = __props;
    return (_ctx, _cache) => {
      return _openBlock$8(), _createElementBlock$8("div", _hoisted_1$m, [
        (_openBlock$8(true), _createElementBlock$8(_Fragment$2, null, _renderList$2(_unref$6(lodash.exports.groupBy)(props2 == null ? void 0 : props2.relatedAlarms, "severity"), (list, key) => {
          return _openBlock$8(), _createElementBlock$8("div", {
            class: _normalizeClass$3(["alarm-count", [`${key.toString().toLowerCase()}-color`, props2.size]]),
            key
...
var AlarmsCountBySeverity = /* @__PURE__ */ _export_sfc$j(_sfc_main$q, [["__scopeId", "data-v-e3cfa67c"]]);
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock$7(), _createElementBlock$7("div", {
        ...
        class: _normalizeClass$2(["card", { selected: props2.selected }])
      }, [
        _createElementVNode$7("div", {
          class: _normalizeClass$2(["severity-line", [`${(_b = (_a = props2.alarmInfo) == null ? void 0 : _a.severity) == null ? void 0 : _b.toLowerCase()}-bg dark`]])
        }, null, 2),
...
var SituationCard = /* @__PURE__ */ _export_sfc$j(_sfc_main$p, [["__scopeId", "data-v-0ff196b9"]]);
...
const _sfc_main$o = /* @__PURE__ */ _defineComponent$6({
  __name: "DateBox",
  props: {
    label: null,
    date: null
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$6(), _createElementBlock$6("div", _hoisted_1$k, [
...
const computed$9 = window["Vue"].computed;
...
const useTab = (props2) => {
  const selected = ref$a(false);
  const tab = ref$a();
  const _controls = ref$a(props2.controls);
  const _id = ref$a(props2.id);
  const focus = () => {
    if (tab.value) {
      tab.value.focus();
    }
...
const _sfc_main$n = defineComponent$8({
  ...
  methods: {
    onClick($event) {
      ...
      requestAnimationFrame(() => {
        ...
        this.styles = __spreadProps$5(__spreadValues$7({}, position), {
          height: `${size}px`,
          width: `${size}px`
        });
        this.pressed = true;
  ...
  render() {
    ...
    return h$4("div", {
      style: __spreadValues$7({}, this.styles),
...
var FeatherRipple = /* @__PURE__ */ _export_sfc$i(_sfc_main$n, [["__scopeId", "data-v-18e2a5db"]]);
...
const useTabContainer = (props2, context) => {
  ...
  const localSelected = ref$9(props2.modelValue);
  const pairs = ref$9([]);
  watch$3(value, (v) => {
    activateIndex(v);
  });
  ...
  const handleKey = (evt) => {
    ...
    const nextKeys = [KEYCODES$1.RIGHT];
    const prevKeys = [KEYCODES$1.LEFT];
    const selectKeys = [KEYCODES$1.ENTER, KEYCODES$1.SPACE];
    if (props2.vertical) {
      nextKeys.push(KEYCODES$1.DOWN);
      prevKeys.push(KEYCODES$1.UP);
    }
...
const mergeProps$2 = window["Vue"].mergeProps;
...
const props$2$3 = stockProps$2;
const _sfc_main$2$2 = defineComponent$7({
  props: props$2$3,
  setup(props2) {
...
const _hoisted_2$1$3 = { class: "tab-text" };
function _sfc_render$2$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock$e(), createElementBlock$e("li", _hoisted_1$1$4, [
    createElementVNode$a("button", mergeProps$2(_ctx.attrs, {
      class: ["tab hover focus", { disabled: _ctx.disabled, selected: _ctx.selected }]
    }), [
      createElementVNode$a("span", _hoisted_2$1$3, [
        renderSlot$4(_ctx.$slots, "default", {}, void 0, true)
      ]),
      createVNode$3(_component_FeatherRipple)
    ], 16)
  ]);
}
var FeatherTab = /* @__PURE__ */ _export_sfc$h(_sfc_main$2$2, [["render", _sfc_render$2$2], ["__scopeId", "data-v-e6bb52b6"]]);
const props$1$4 = stockProps$1;
const emits$3 = emits$4;
const _sfc_main$1$4 = defineComponent$7({
  model,
  emits: emits$3,
  props: props$1$4,
...
function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives$1((openBlock$e(), createElementBlock$e("div", normalizeProps(guardReactiveProps(_ctx.attrs)), [
    renderSlot$4(_ctx.$slots, "default")
  ], 16)), [
    [vShow$1, _ctx.selected]
  ]);
}
var FeatherTabPanel = /* @__PURE__ */ _export_sfc$h(_sfc_main$m, [["render", _sfc_render$e]]);
var style$7 = "";
...
const toRaw$1 = window["Vue"].toRaw;
...
const _sfc_main$l = defineComponent$6({
  ...
  render() {
    ...
    _attrs["role"] = "img";
    let icon = toRaw$1(this.icon);
    if (this.$slots.default) {
      return h$3("span", { class: "feather-icon-container" }, [
        h$3(this.$slots.default()[0], __spreadValues$6({
          class: cls
        }, _attrs))
      ]);
    }
    return h$3(icon, __spreadValues$6({
      class: cls
    }, _attrs));
  }
});
var FeatherIcon$1 = /* @__PURE__ */ _export_sfc$g(_sfc_main$l, [["__scopeId", "data-v-52cbf270"]]);
...
var CheckCircle = /* @__PURE__ */ _export_sfc$f(_sfc_main$k, [["render", _sfc_render$d]]);
...
var Cancel$2 = /* @__PURE__ */ _export_sfc$e(_sfc_main$j, [["render", _sfc_render$c]]);
var CONST = {
...
const saveEngineParameter = async (engineName, hellinger) => {
  try {
    const resp = await rest.post(engineEndpoint, {
      distanceMeasureName: hellinger ? CONST.HELLINGER_OPTION : CONST.SPACE_DISTANCE_OPTION,
      engineName,
      alpha: 144.47117699,
      beta: 0.55257784,
      epsilon: 100
  ...
  render() {
    ...
    if (this.$slots.default) {
      return h$2("span", { class: "feather-icon-container" }, [
        h$2(this.$slots.default()[0], __spreadValues$5({
          class: cls
        }, _attrs))
      ]);
    }
    return h$2(icon, __spreadValues$5({
      class: cls
    }, _attrs));
  }
});
var FeatherIcon = /* @__PURE__ */ _export_sfc$d(_sfc_main$i, [["__scopeId", "data-v-52cbf270"]]);
...
var Cancel$1 = /* @__PURE__ */ _export_sfc$c(_sfc_main$h, [["render", _sfc_render$b]]);
...
const useSelection = (current, radios, select) => {
  ...
  const index = computed$6(() => current.value ? notDisabled.value.indexOf(current.value) : -1);
  return {
    selectPrevious() {
...
var Cancel = /* @__PURE__ */ _export_sfc$b(_sfc_main$g, [["render", _sfc_render$a]]);
...
const _hoisted_4$8 = /* @__PURE__ */ createElementVNode$5("rect", {
  x: "11",
  y: "15",
  width: "2",
  height: "2",
...
function _sfc_render$9(_ctx, _cache) {
  return openBlock$9(), createElementBlock$9("svg", _hoisted_1$e, _hoisted_5$6);
}
var Warning = /* @__PURE__ */ _export_sfc$a(_sfc_main$f, [["render", _sfc_render$9]]);
...
const _sfc_main$5$2 = defineComponent$4({
  props: props$2$2,
  components: {
    FeatherIcon: FeatherIcon$1
  }
});
const _hoisted_1$3$2 = ["title"];
function _sfc_render$5$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FeatherIcon = resolveComponent$3("FeatherIcon");
  return openBlock$8(), createElementBlock$8("a", {
    title: _ctx.title,
...
var ActionIcon = /* @__PURE__ */ _export_sfc$9(_sfc_main$5$2, [["render", _sfc_render$5$2], ["__scopeId", "data-v-4265058e"]]);
const _sfc_main$4$2 = defineComponent$4({
  emits: ["clear"],
  props: {
    clear: {
      type: String,
...
function _sfc_render$4$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock$8(), createBlock$3(_component_ActionIcon, {
...
var ClearIcon = /* @__PURE__ */ _export_sfc$9(_sfc_main$4$2, [["render", _sfc_render$4$2]]);
const _sfc_main$3$2 = defineComponent$4({
  computed: {
    errorIcon() {
      return Warning;
    }
...
function _sfc_render$3$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FeatherIcon = resolveComponent$3("FeatherIcon");
  return openBlock$8(), createBlock$3(_component_FeatherIcon, {
    icon: _ctx.errorIcon,
    class: "error-icon hide-when-disabled",
    "data-ref-id": "error-icon"
  }, null, 8, ["icon"]);
}
var ErrorIcon = /* @__PURE__ */ _export_sfc$9(_sfc_main$3$2, [["render", _sfc_render$3$2], ["__scopeId", "data-v-0b8faef3"]]);
const props$1$3 = {
  for: {
    type: String,
    required: true
...
defineComponent$4({
  ...
  setup() {
    const options = inject$4("wrapperOptions", {});
    const errorMessage = inject$4("validationErrorMessage", false);
    ...
    return __spreadProps$4(__spreadValues$4({}, options), { error });
  },
  computed: {
    computedClearText() {
      if (this.clearText) {
...
const _sfc_main$1$3 = defineComponent$4({
  setup() {
    const options = inject$4("subTextOptions", {});
    const errorMessage = inject$4("validationErrorMessage", false);
    const error = computed$5(() => {
      if (options.error) {
        return options.error;
...
function _sfc_render$1$3(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock$8(), createElementBlock$8("div", _hoisted_1$1$3, [
    !_ctx.hint && !_ctx.error.length ? (openBlock$8(), createElementBlock$8("div", _hoisted_2$1$2, "\xA0")) : createCommentVNode$3("", true),
    _ctx.hint && !_ctx.error.length ? (openBlock$8(), createElementBlock$8("div", _hoisted_3$1$1, toDisplayString$1(_ctx.hint), 1)) : createCommentVNode$3("", true),
    _ctx.error.length > 0 ? (openBlock$8(), createElementBlock$8("div", _hoisted_4$1$1, toDisplayString$1(_ctx.error), 1)) : createCommentVNode$3("", true),
    renderSlot$3(_ctx.$slots, "right", {}, void 0, true)
  ], 512)), [
    [vShow, !_ctx.inline || _ctx.hint || _ctx.error.length]
  ]);
}
var InputSubText = /* @__PURE__ */ _export_sfc$9(_sfc_main$1$3, [["render", _sfc_render$1$3], ["__scopeId", "data-v-8e0ac99e"]]);
const props$5 = {
  headingText: {
    type: Function,
    default: (errors) => {
...
defineComponent$4({
  props: props$5,
  setup(props2) {
    const formErrors = inject$4("featherFormErrors", ref$7([]));
...
const useValidation = (inputId, value, label, schema, errorFromInput) => {
  const form = inject$4("featherForm", false);
  if (schema && form && inputId.value) {
    const errorMessage = ref$7("");
    ...
    if (errorFromInput && isRef(errorFromInput)) {
      watch$2(errorFromInput, () => {
        form.runValidation();
      });
    }
    watch$2(inputId, (curr, old) => {
      if (curr && form) {
...
const useRadioGroup = (modelValue, emit, label, schema, errorFromInput) => {
  const radios = ref$6([]);
  const currentSelected = ref$6();
  const firstElement = ref$6();
  const firstElementId = ref$6();
  watchEffect(() => {
  ...
  const currentHighlight = computed$4(() => {
    return currentSelected.value || firstElement.value;
  });
  const selection = useSelection(currentHighlight, radios, select);
  const groupId = computed$4(() => {
    return getSafeId$1("feather-radio-group");
  });
  firstElementId.value = groupId.value;
  const { validate } = useValidation(firstElementId, modelValue, label, schema, errorFromInput);
...
const _sfc_main$8$1 = defineComponent$3({
  props: props$3$1,
  setup(props2) {
    const groupCondensed = inject$3("isCondensed", null);
    const isCondensed = computed$3(() => {
      return groupCondensed || props2.condensed;
    });
    const focused = ref$5(false);
    const handleFocus = () => {
      focused.value = true;
    };
    const handleBlur = () => {
...
const _hoisted_1$6$1 = ["aria-disabled"];
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FeatherRipple = resolveComponent$2("FeatherRipple");
  return openBlock$7(), createElementBlock$7("div", {
    class: normalizeClass(["chip", {
      condensed: _ctx.isCondensed,
      disabled: _ctx.disabled,
      focused: _ctx.focused
    }]),
    onFocusin: _cache[0] || (_cache[0] = ($event) => _ctx.clickable ? _ctx.handleFocus : null),
    onFocusout: _cache[1] || (_cache[1] = ($event) => _ctx.clickable ? _ctx.handleBlur : null),
    "aria-disabled": _ctx.disabled
  }, [
    renderSlot$2(_ctx.$slots, "default", {}, void 0, true),
    _ctx.clickable ? (openBlock$7(), createBlock$2(_component_FeatherRipple, { key: 0 })) : createCommentVNode$2("", true)
  ], 42, _hoisted_1$6$1);
}
var Chip = /* @__PURE__ */ _export_sfc$8(_sfc_main$8$1, [["render", _sfc_render$7], ["__scopeId", "data-v-44d413dc"]]);
const props$2$1 = {
  disabled: {
    type: Boolean,
    default: false
...
const _sfc_main$7$1 = defineComponent$3({
  emits: ["delete"],
  props: props$2$1,
  setup(props2, context) {
    const handleDelete = () => {
...
function _sfc_render$6$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock$7(), createElementBlock$7("span", _hoisted_1$5$1, [
    createElementVNode$4("a", {
      href: "#",
      class: "delete-icon",
      role: "button",
      onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.handleDelete && _ctx.handleDelete(...args), ["stop", "prevent"])),
      "aria-label": _ctx.label,
      "aria-describedby": _ctx.textId
    }, [
      createVNode$1(_component_FeatherIcon, {
        icon: _ctx.icon,
        flex: ""
      }, null, 8, ["icon"])
    ], 8, _hoisted_2$d)
...
const _sfc_main$6$1 = defineComponent$3({
  data() {
    return {
      titleText: void 0
    };
...
const _hoisted_1$4$1 = ["title"];
function _sfc_render$5$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock$7(), createElementBlock$7("span", {
    class: "label",
...
var Label = /* @__PURE__ */ _export_sfc$8(_sfc_main$6$1, [["render", _sfc_render$5$1], ["__scopeId", "data-v-1a0445b2"]]);
const _sfc_main$5$1 = {};
...
function _sfc_render$4$1(_ctx, _cache) {
  return openBlock$7(), createElementBlock$7("span", _hoisted_1$3$1, [
    renderSlot$2(_ctx.$slots, "default", {}, void 0, true)
  ]);
}
var PreIcon = /* @__PURE__ */ _export_sfc$8(_sfc_main$5$1, [["render", _sfc_render$4$1], ["__scopeId", "data-v-2230176f"]]);
const LABELS = {
  delete: "Remove"
};
const _sfc_main$4$1 = defineComponent$3({
  ...
  setup(props2, context) {
    const labels = useLabelProperty(toRef$2(props2, "labels"), LABELS);
    const chipTextId = computed$3(() => getSafeId("chip-text"));
    const handleClick = () => {
      if (props2.disabled) {
        return;
      }
    ...
    const _attrs = __spreadValues$3({}, context.attrs);
    if (props2.disabled) {
      delete _attrs.onClick;
    }
    return __spreadProps$3(__spreadValues$3({}, labels), {
      chipTextId,
      handleClick,
      attrs: _attrs
    });
  ...
  computed: {
    ...
    hasIcon() {
      const hasIcon = this.$slots.icon && this.$slots.icon().findIndex((o) => o.children && o.children.length !== 0 || typeof o.type === "object") !== -1;
      return hasIcon;
    }
  },
  components: {
...
const _hoisted_1$2$1 = ["aria-disabled"];
function _sfc_render$3$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_PreIcon = resolveComponent$2("PreIcon");
  const _component_Label = resolveComponent$2("Label");
  const _component_DeleteIcon = resolveComponent$2("DeleteIcon");
  const _component_Chip = resolveComponent$2("Chip");
  return openBlock$7(), createBlock$2(_component_Chip, mergeProps$1(_ctx.attrs, {
    disabled: _ctx.disabled,
    condensed: _ctx.condensed,
    class: { hover: _ctx.canClick, focus: _ctx.canClick || _ctx.canDelete },
    role: "row",
    clickable: _ctx.canClick
  }), {
    default: withCtx(() => [
      createElementVNode$4("span", {
        role: "gridcell",
        "aria-disabled": _ctx.disabled
      }, [
        createElementVNode$4("span", mergeProps$1(_ctx.chipTextAttrs, { class: "chip-label-button" }), [
          _ctx.hasIcon ? (openBlock$7(), createBlock$2(_component_PreIcon, { key: 0 }, {
            default: withCtx(() => [
              renderSlot$2(_ctx.$slots, "icon", {}, void 0, true)
            ]),
            _: 3
          })) : createCommentVNode$2("", true),
          createVNode$1(_component_Label, { id: _ctx.chipTextId }, {
            default: withCtx(() => [
              renderSlot$2(_ctx.$slots, "default", {}, void 0, true)
            ]),
            _: 3
      ...
      _ctx.canDelete ? (openBlock$7(), createBlock$2(_component_DeleteIcon, {
        key: 0,
        disabled: _ctx.disabled,
        "text-id": _ctx.chipTextId,
        label: _ctx.deleteLabel,
        role: "gridcell",
        onDelete: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("delete"))
      }, null, 8, ["disabled", "text-id", "label"])) : createCommentVNode$2("", true)
    ]),
    _: 3
  }, 16, ["disabled", "condensed", "class", "clickable"]);
}
var GridChip = /* @__PURE__ */ _export_sfc$8(_sfc_main$4$1, [["render", _sfc_render$3$1], ["__scopeId", "data-v-48b2704a"]]);
...
const _hoisted_1$1$2 = ["aria-disabled"];
function _sfc_render$2$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_PreIcon = resolveComponent$2("PreIcon");
  const _component_Label = resolveComponent$2("Label");
  const _component_Chip = resolveComponent$2("Chip");
  return openBlock$7(), createBlock$2(_component_Chip, {
    role: "row",
    disabled: _ctx.disabled,
    condensed: _ctx.condensed,
    clickable: false
    ...
    default: withCtx(() => [
      createElementVNode$4("span", {
        ...
        createVNode$1(_component_Label, null, {
          default: withCtx(() => [
            renderSlot$2(_ctx.$slots, "default", {}, void 0, true)
          ]),
          _: 3
...
var ReadonlyChip = /* @__PURE__ */ _export_sfc$8(_sfc_main$3$1, [["render", _sfc_render$2$1], ["__scopeId", "data-v-3e0c4eba"]]);
const _sfc_main$2$1 = defineComponent$3({
  props: {
    value: {
  ...
  setup(props2) {
    const first = ref$5(false);
    const checked = ref$5(false);
    const labelId = computed$3(() => getSafeId("chip-label-id"));
    const tabindex = computed$3(() => {
      if (first.value) {
        return 0;
      }
    ...
    const register = inject$3("register", (_t) => {
    });
    const blur = inject$3("blur", (_t) => {
    });
    const select = inject$3("select", (_t) => {
    });
    const vm = {
      first,
      focus,
...
function _sfc_render$1$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock$7(), createBlock$2(_component_Chip, {
    disabled: _ctx.disabled,
    condensed: _ctx.condensed,
    class: normalizeClass(["focus hover", { selected: _ctx.checked }]),
    role: "radio",
    ref: "input",
    ...
    default: withCtx(() => [
      ...
      createVNode$1(_component_Label, { id: _ctx.labelId }, {
        default: withCtx(() => [
          renderSlot$2(_ctx.$slots, "default", {}, void 0, true)
        ]),
        _: 3
...
var RadioChip = /* @__PURE__ */ _export_sfc$8(_sfc_main$2$1, [["render", _sfc_render$1$2], ["__scopeId", "data-v-bbcc2f70"]]);
const props$1$2 = {
  disabled: {
    type: Boolean,
    default: false
...
const _sfc_main$1$2 = defineComponent$3({
  props: props$1$2,
  setup() {
    const format = inject$3("chipListFormat", "");
    return { format };
  },
  render() {
    const renderChip = (component) => {
      return h$1(component, __spreadValues$3(__spreadValues$3({}, this.$props), this.$attrs), __spreadValues$3({
...
const _sfc_main$e = defineComponent$3({
  ...
  props: props$4,
  setup(props2, context) {
    const format = props2.mode === "list" ? "grid" : props2.mode;
    ...
    if (format === "radio") {
      ...
      return __spreadProps$3(__spreadValues$3({
        attrs: attrs2
      }, useRadioGroup(modelValue, context.emit, props2.label, {}, ref$5(""))), {
        single
      });
    }
    const attrs = {
...
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock$7(), createElementBlock$7("div", mergeProps$1(_ctx.attrs, {
    ...
    "aria-label": _ctx.label,
    class: ["chip-list", { condensed: _ctx.condensed, single: _ctx.single }],
    onKeydown: _cache[0] || (_cache[0] = (...args) => _ctx.keydown && _ctx.keydown(...args))
  }), [
    renderSlot$2(_ctx.$slots, "default", {}, void 0, true)
  ], 16, _hoisted_1$d);
}
var FeatherChipList = /* @__PURE__ */ _export_sfc$8(_sfc_main$e, [["render", _sfc_render$8], ["__scopeId", "data-v-1e06f41d"]]);
...
const _withScopeId$7 = (n) => (_pushScopeId$5("data-v-88fba17a"), n = n(), _popScopeId$5(), n);
const _hoisted_1$c = {
  key: 0,
  class: "card"
};
...
const _hoisted_5$5 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ _createElementVNode$5("strong", null, "Last Event", -1));
const _hoisted_6$3 = { class: "row" };
const _hoisted_7$4 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ _createElementVNode$5("strong", null, "Reduction Key:", -1));
...
const _sfc_main$d = /* @__PURE__ */ _defineComponent$5({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return _unref$5(alarm) ? (_openBlock$5(), _createElementBlock$5("div", _hoisted_1$c, [
        _createElementVNode$5("div", _hoisted_2$c, "[" + _toDisplayString$2(_unref$5(alarm).id) + "]", 1),
        _createElementVNode$5("div", _hoisted_3$9, [
        ...
        _createElementVNode$5("div", null, [
          _hoisted_7$4,
          _createTextVNode$4(" " + _toDisplayString$2(_unref$5(alarm).reductionKey), 1)
        ]),
...
var AlarmDetail = /* @__PURE__ */ _export_sfc$j(_sfc_main$d, [["__scopeId", "data-v-88fba17a"]]);
...
const _withScopeId$6 = (n) => (_pushScopeId$4("data-v-45e00478"), n = n(), _popScopeId$4(), n);
const _hoisted_1$b = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ _createElementVNode$4("div", { class: "id" }, [
  /* @__PURE__ */ _createElementVNode$4("div", null, "Alarms")
], -1));
const _hoisted_2$b = /* @__PURE__ */ _createTextVNode$3(" Show All ");
const _hoisted_3$8 = { class: "section" };
const _hoisted_4$6 = { class: "alarm-list" };
...
const _sfc_main$c = /* @__PURE__ */ _defineComponent$4({
  ...
  setup(__props) {
    ...
    const selectedFilters = ref$4(["all"]);
    const alarms = ref$4(props2.relatedAlarms);
    ...
    return (_ctx, _cache) => {
      return _openBlock$4(), _createElementBlock$4(_Fragment$1, null, [
        ...
        _createElementVNode$4("div", _hoisted_3$8, [
...
var AlarmFilters = /* @__PURE__ */ _export_sfc$j(_sfc_main$c, [["__scopeId", "data-v-45e00478"]]);
var style$3 = "";
...
const _sfc_main$b = defineComponent$2({
  ...
  props: props$3,
  setup() {
    const hasTooltip = inject$2("feather-has-tooltip", false);
    return { hasTooltip };
  },
  render() {
    const getClasses = () => {
    ...
    const data2 = {};
    const _attrs = __spreadValues$2({}, this.$attrs);
    data2.attrs = _attrs || {};
    if (this.asAnchor) {
    ...
    if (this.icon && this.$slots.default) {
      ...
      return h(tag, __spreadProps$2(__spreadValues$2(__spreadValues$2({}, data2.attrs), data2.on), { class: data2.class }), [
        this.$slots.default(),
...
const _withScopeId$5 = (n) => (_pushScopeId$3("data-v-1e915abf"), n = n(), _popScopeId$3(), n);
const _hoisted_1$a = {
  key: 0,
  class: "detail"
};
...
const _hoisted_5$4 = /* @__PURE__ */ _createTextVNode$2(" Accept ");
const _hoisted_6$2 = /* @__PURE__ */ _createTextVNode$2(" Reject ");
...
const _hoisted_14$1 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ _createElementVNode$3("div", { class: "separator" }, null, -1));
const _hoisted_15$1 = { class: "section" };
...
var SituationDetail = /* @__PURE__ */ _export_sfc$j(_sfc_main$a, [["__scopeId", "data-v-1e915abf"]]);
...
const _withScopeId$4 = (n) => (_pushScopeId$2("data-v-3a279038"), n = n(), _popScopeId$2(), n);
const _hoisted_1$9 = { class: "list-main" };
const _hoisted_2$9 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ _createElementVNode$2("h2", null, "Situation List", -1));
const _hoisted_3$6 = { class: "container" };
const _hoisted_4$4 = { class: "situation-list" };
const reactive$1 = window["Vue"].reactive;
const _sfc_main$9 = /* @__PURE__ */ _defineComponent$2({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$2(), _createElementBlock$2("div", _hoisted_1$9, [
        _hoisted_2$9,
        _createElementVNode$2("div", _hoisted_3$6, [
          _createElementVNode$2("div", _hoisted_4$4, [
...
var SituationList = /* @__PURE__ */ _export_sfc$j(_sfc_main$9, [["__scopeId", "data-v-3a279038"]]);
var style$2 = "";
...
const _sfc_main$1$1 = defineComponent$1({
  ...
  setup(props2) {
    ...
    const blur = inject$1("blur", (_e) => {
    });
    const select = inject$1("select", (_radio) => {
    });
    register(vm);
    const click = () => {
      select(vm);
...
const _withScopeId$3 = (n) => (pushScopeId$1("data-v-24790cf0"), n = n(), popScopeId$1(), n);
const _hoisted_1$1$1 = { class: "layout-container" };
const _hoisted_2$1$1 = ["id", "aria-checked", "aria-disabled", "aria-labelledby", "tabindex"];
const _hoisted_3$5 = { class: "radio hover focus" };
const _hoisted_4$3 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createElementVNode$3("div", {
  class: "icon",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createElementVNode$3("svg", { class: "dot" }, [
    /* @__PURE__ */ createElementVNode$3("circle", {
      cx: "50%",
      cy: "50%",
      r: "0.3125rem",
      stroke: "black",
...
function _sfc_render$1$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_feather_ripple = resolveComponent$1("feather-ripple");
  return openBlock$6(), createElementBlock$6("div", _hoisted_1$1$1, [
    createElementVNode$3("div", {
      class: "feather-radio",
      role: "radio",
      ref: "input",
      id: _ctx.id,
      ...
      createElementVNode$3("div", _hoisted_3$5, [
        _hoisted_4$3,
        !_ctx.vm.disabled ? (openBlock$6(), createBlock$1(_component_feather_ripple, {
          key: 0,
          center: ""
...
var FeatherRadio = /* @__PURE__ */ _export_sfc$6(_sfc_main$1$1, [["render", _sfc_render$1$1], ["__scopeId", "data-v-24790cf0"]]);
const props$2 = __spreadProps$1(__spreadValues$1({}, InputSubTextProps), {
  label: {
    type: String,
    required: true
  },
...
const _sfc_main$8 = defineComponent$1({
  ...
  setup(props2, context) {
    ...
    return __spreadValues$1(__spreadValues$1({
      descriptionId,
      attrs
    }, useRadioGroup(modelValue, context.emit, props2.label, props2.schema, toRef$1(props2, "error"))), useInputInheritAttrs(context.attrs));
  },
  components: {
    InputSubText
  }
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_InputSubText = resolveComponent$1("InputSubText");
  return openBlock$6(), createElementBlock$6("div", mergeProps(_ctx.inherittedAttrs, {
    class: ["feather-radio-group-container", { vertical: _ctx.vertical }]
  }), [
    createElementVNode$3("label", {
      for: _ctx.groupId,
      class: "group-label"
    }, toDisplayString(_ctx.label), 9, _hoisted_1$8),
    createElementVNode$3("div", mergeProps(_ctx.attrs, {
    ...
    createVNode(_component_InputSubText, { id: _ctx.descriptionId }, null, 8, ["id"])
  ], 16);
}
var FeatherRadioGroup = /* @__PURE__ */ _export_sfc$6(_sfc_main$8, [["render", _sfc_render$6], ["__scopeId", "data-v-6775aeb9"]]);
...
function _sfc_render$5(_ctx, _cache) {
  return openBlock$5(), createElementBlock$5("svg", _hoisted_1$7, _hoisted_8$2);
}
var Options = /* @__PURE__ */ _export_sfc$5(_sfc_main$7, [["render", _sfc_render$5]]);
...
const _hoisted_2$6 = /* @__PURE__ */ createStaticVNode$1('<rect x="8" y="7" width="8" height="2" rx="1"></rect><rect x="8" y="11" width="8" height="2" rx="1"></rect><rect x="8" y="15" width="8" height="2" rx="1"></rect><path d="M21,21l-3-3v2H6V9L4,7V20a2,2,0,0,0,2,2H18v2Z"></path><path d="M6,4H18V15l2,2V4a2,2,0,0,0-2-2H6V0L3,3,6,6Z"></path>', 5);
const _hoisted_7$2 = [
  _hoisted_2$6
];
function _sfc_render$4(_ctx, _cache) {
  return openBlock$4(), createElementBlock$4("svg", _hoisted_1$6, _hoisted_7$2);
}
var InformationExchange = /* @__PURE__ */ _export_sfc$4(_sfc_main$6, [["render", _sfc_render$4]]);
...
const _hoisted_2$5 = /* @__PURE__ */ createElementVNode$2("path", { d: "M17,10h5a1,1,0,0,0,1-1V3a1,1,0,0,0-1-1H17a1,1,0,0,0-1,1V5.59L10.59,11H8V9A1,1,0,0,0,7,8H2A1,1,0,0,0,1,9v6a1,1,0,0,0,1,1H7a1,1,0,0,0,1-1V13h2.58L16,18.49V21a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1V15a1,1,0,0,0-1-1H17a1,1,0,0,0-1,1v.64L12.41,12,16,8.42V9A1,1,0,0,0,17,10Zm1,6h3v4H18ZM18,4h3V8H18Z" }, null, -1);
const _hoisted_3$4 = [
  _hoisted_2$5
];
function _sfc_render$3(_ctx, _cache) {
  return openBlock$3(), createElementBlock$3("svg", _hoisted_1$5, _hoisted_3$4);
}
var Workflow = /* @__PURE__ */ _export_sfc$3(_sfc_main$5, [["render", _sfc_render$3]]);
...
function _sfc_render$2(_ctx, _cache) {
  return openBlock$2(), createElementBlock$2("svg", _hoisted_1$4, _hoisted_11$1);
}
var Apps = /* @__PURE__ */ _export_sfc$2(_sfc_main$4, [["render", _sfc_render$2]]);
...
const _hoisted_2$3 = /* @__PURE__ */ createElementVNode$1("path", { d: "M18,6a4,4,0,0,0-1,7.86V18a2,2,0,0,1-2,2H10a2,2,0,0,1-2-2V12.9a5.5,5.5,0,0,0,4.5-5.4V5a2,2,0,0,0-2-2h-1a1,1,0,0,0,0,2h1V7.5a3.5,3.5,0,0,1-7,0V5h1a1,1,0,0,0,0-2h-1a2,2,0,0,0-2,2V7.5A5.5,5.5,0,0,0,6,12.9V18a4,4,0,0,0,4,4h5a4,4,0,0,0,4-4V13.86A4,4,0,0,0,18,6Zm0,6a2,2,0,1,1,2-2A2,2,0,0,1,18,12Z" }, null, -1);
const _hoisted_3$3 = [
  _hoisted_2$3
];
function _sfc_render(_ctx, _cache) {
  return openBlock$1(), createElementBlock$1("svg", _hoisted_1$3, _hoisted_3$3);
}
var Vitals = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["render", _sfc_render]]);
const useRouter = () => {
...
const _withScopeId$2 = (n) => (_pushScopeId$1("data-v-1331ae83"), n = n(), _popScopeId$1(), n);
const _hoisted_1$2 = { class: "container" };
const _hoisted_2$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("div", { class: "title" }, "ALEC", -1));
const _hoisted_3$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("div", { class: "description" }, [
...
const _hoisted_4$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("h3", null, "Key Benefits:", -1));
const _hoisted_5$2 = { class: "list" };
const _hoisted_6$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("span", null, " Alleviate alarm load by clustering them into actionable situations. ", -1));
const _hoisted_7$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("span", null, "Assist in root cause analysis.", -1));
const _hoisted_8$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("span", null, " Avoid potential issues flagged by alarms with low visibility. ", -1));
const _hoisted_9$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("span", null, "Easy configuration.", -1));
const _hoisted_10$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("span", null, " Continuous improvement. Provided anonymized data helps us improve ALEC. ", -1));
const _hoisted_11 = {
  key: 0,
  class: "optin"
};
const _hoisted_12 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("h3", null, "Enable ALEC for more precise results:", -1));
const _hoisted_13 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("div", null, " Our goal with ALEC, is to aid IT Operators to tackle these issues effectively identifying alarm groups that are easier to manage. The information provided is anonymized and will be used for internal purposes only. ", -1));
const _hoisted_14 = { class: "choices" };
const _hoisted_15 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ _createElementVNode$1("div", { class: "radio-text" }, " By choosing \u201CYes\u201D you accept that OpenNMS can store the information that you provide, for educational and research purposes. ", -1));
...
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock$1("div", _hoisted_1$2, [
        _hoisted_2$2,
        _hoisted_3$2,
        _createElementVNode$1("div", null, [
          _hoisted_4$2,
          _createElementVNode$1("div", _hoisted_5$2, [
            _createElementVNode$1("div", null, [
              _createVNode$1(_unref$1(FeatherIcon$1), {
                icon: _unref$1(Apps),
                "aria-hidden": "true",
                class: "icon"
              }, null, 8, ["icon"]),
        ...
        _unref$1(userStore).isAdmin ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_11, [
          _hoisted_12,
          _hoisted_13,
          _createElementVNode$1("div", _hoisted_14, [
            _hoisted_15,
            _createVNode$1(_unref$1(FeatherRadioGroup), {
              horizontal: "",
              modelValue: allowSave.value,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => allowSave.value = $event),
              label: ""
            }, {
              default: _withCtx$1(() => [
                _createVNode$1(_unref$1(FeatherRadio), { value: true }, {
                  default: _withCtx$1(() => [
                    _hoisted_16
                  ]),
                  _: 1
                }),
                _createVNode$1(_unref$1(FeatherRadio), { value: false }, {
                  default: _withCtx$1(() => [
                    _hoisted_17
                  ]),
                  _: 1
...
const _sfc_main$1 = defineComponent({
  ...
  computed: {
    inputId() {
      return this.label && this.label.length ? void 0 : getSafeId("checkbox");
    },
    labelId() {
      return this.label && this.label.length ? void 0 : getSafeId("checkbox-label");
    }
  },
  watch: {
    indeterminate: {
...
const _withScopeId = (n) => (_pushScopeId("data-v-dc1bdb68"), n = n(), _popScopeId(), n);
...
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ _createElementVNode("p", null, [
  /* @__PURE__ */ _createTextVNode(" ALEC relies on correlation engines to identify related alarm groupings (situations). These engines are powered by machine learning techniques that leverage alarms data to make informed decisions. "),
  /* @__PURE__ */ _createElementVNode("br"),
  /* @__PURE__ */ _createTextVNode(" For detail information about proposed engines you can read "),
...
const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ _createElementVNode("strong", { class: "title" }, "Clustering", -1));
...
const _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ _createElementVNode("div", { class: "hellinger" }, [
  /* @__PURE__ */ _createElementVNode("strong", null, "With hellinger distance"),
  /* @__PURE__ */ _createElementVNode("br"),
  /* @__PURE__ */ _createElementVNode("span", { class: "description" }, " (Uses the Hellinger Distance between alarms as a scaling variable. It pushes alarms further apart if its value is high and vice versa.) ")
], -1));
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ _createElementVNode("div", { class: "radio-content" }, [
  /* @__PURE__ */ _createElementVNode("strong", { class: "title" }, "Deep Learning"),
          ...
          _createVNode(_unref(FeatherRadioGroup), {
            ...
            default: _withCtx(() => [
              _createVNode(_unref(FeatherRadio), {
                class: "radio",
                value: _unref(CONST).ENGINE_DBSCAN
              }, {
                default: _withCtx(() => [
                  _createElementVNode("div", _hoisted_4, [
                    ...
                    _createVNode(_unref(FeatherCheckbox), {
                      ...
                      disabled: engine.value !== _unref(CONST).ENGINE_DBSCAN,
                      class: "checkbox"
                    }, {
                      default: _withCtx(() => [
                        _hoisted_8
              ...
              _createVNode(_unref(FeatherRadio), {
                class: "radio",
                value: _unref(CONST).ENGINE_DEEP_LEARNING
              }, {
                default: _withCtx(() => [
                  _hoisted_9
                ]),
...
var ConfigurationPage = /* @__PURE__ */ _export_sfc$j(_sfc_main, [["__scopeId", "data-v-dc1bdb68"]]);
const createRouter = window["VueRouter"].createRouter;
const createWebHistory = window["VueRouter"].createWebHistory;
const checkUser = async () => {
  const r = window.VRouter || router;
  const userStore = useUserStore();
  if (!userStore.userId) {
